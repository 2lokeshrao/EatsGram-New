...
const Rider = () => {
  ...
  const cards = [
    {
      heading: t("EatsGram_rider_page_name_card1_heading"),
      text: t("EatsGram_rider_page_name_card1_text"),
      image: growth,
      color: "#f7fbfe",
    },
    {
      heading: t("EatsGram_rider_page_name_card2_heading"),
      text: t("EatsGram_rider_page_name_card2_text"),
      image: getMoreOrders,
      color: "#faf7fc",
    },
    {
      heading: t("EatsGram_rider_page_name_card3_heading"),
      text: t("EatsGram_rider_page_name_card3_text"),
  ...
  return (
    <div className="w-screen h-auto">
      <Heading heading={t("EatsGram_rider_page_name_main_heading")} />
      <StartingImage image={RiderBanner} />
      <WhyChoose
        heading={t("EatsGram_rider_page_name_why_heading")}
        subHeading={t("EatsGram_rider_page_name_why_subheading")}
      />
      <WhyCardsList cards={cards} />
      <hr className="w-[30%] ml-12 border-4 border-green-400 my-12 rounded" />
      <EmailForm
        heading={t("EatsGram_rider_page_name_form_heading")}
        role={t("EatsGram_rider_page_name_form_role")}
      />
    </div>
  );
};
