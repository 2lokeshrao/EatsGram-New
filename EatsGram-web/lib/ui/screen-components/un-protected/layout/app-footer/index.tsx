...
const AppFooter = () => {
  ...
  const products = {
    ...
    links: [
      {
        label: t("Footer.EatsGramRider"),
        link: "https://play.google.com/store/apps/details?id=com.EatsGram.multirider&hl=en",
        internal: false,
      },
      {
        label: t("Footer.EatsGramRestaurant"),
        link: "https://play.google.com/store/apps/details?id=multivendor.EatsGram.restaurant&hl=en",
        internal: false,
      },
    ],
  };
  ...
  const followUs = {
    ...
    links: [
      ...
      },
      {
        ...
        link: "https://www.facebook.com/EatsGram/",
        internal: false,
      },
      {
        label: t("Footer.linkedIn"),
        link: "https://www.linkedin.com/company/EatsGram/?originalSubdomain=pk",
        internal: false,
      },
    ],
  };
