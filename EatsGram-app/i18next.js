...
const detectAndSetLanguage = async () => {
  try {
    const storedLanguage = await AsyncStorage.getItem('EatsGram-language');
    ...
    await AsyncStorage.removeItem('EatsGram-language');
    await AsyncStorage.removeItem('EatsGram-language-name');
  } catch (error) {
