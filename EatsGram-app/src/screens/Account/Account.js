...
function Account(props) {
  ...
  const fetchSelectedLanguage = async () => {
    const lang = await AsyncStorage.getItem('EatsGram-language-name')
              ...
              <View style={styles(currentTheme).subContainer}>
                ...
                <View>
                  ...
                  <ButtonContainer
                    ...
                    status='null'
                    onPress={() => {
                      Linking.openURL('https://multivendor.EatsGram.com/terms')
                    }}
                  />
                  <View style={styles(currentTheme).line} />
                  ...
                  <ButtonContainer
                    ...
                    status='null'
                    onPress={() => {
                      Linking.openURL('https://multivendor.EatsGram.com/privacy')
                    }}
                  />
                </View>
